...
namespace {
  ...
  public:
    ...
    //Armin H.
    SimpleCost(const boost::property_tree::ptree& pt, valhalla::baldr::GraphReader& graphreader)
  ...
  //Armin H.
  cost_ptr_t CreateSimpleCost (const boost::property_tree::ptree& pt, valhalla::baldr::GraphReader& graphreader) {
    return std::make_shared<SimpleCost> (pt, graphreader);
  }
...
void test_matrix() {
  ...
  //Armin H.
  cost_ptr_t costing = CreateSimpleCost(request_pt, reader);
