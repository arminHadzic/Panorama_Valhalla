...
public:
  //Armin H.
  DistanceOnlyCost(vs::TravelMode travel_mode, vb::GraphReader& graphreader);
...
//Armin H.
DistanceOnlyCost::DistanceOnlyCost(vs::TravelMode travel_mode, vb::GraphReader& graphreader)
  : DynamicCost(bpt::ptree(), graphreader, travel_mode) {
}
...
edge_association::edge_association(const bpt::ptree &pt)
  : m_reader(pt.get_child("mjolnir")),
    ...
    m_costing(new DistanceOnlyCost(m_travel_mode, m_reader)) {
}
