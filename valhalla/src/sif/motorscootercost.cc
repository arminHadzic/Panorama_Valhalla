...
class MotorScooterCost : public DynamicCost {
 public:
   ...
   */
  //Armin H.
  MotorScooterCost(const boost::property_tree::ptree& config, baldr::GraphReader& graphreader);
...
// Constructor
//Armin H.
MotorScooterCost::MotorScooterCost(const boost::property_tree::ptree& pt, baldr::GraphReader& graphreader)
...
cost_ptr_t CreateMotorScooterCost(const boost::property_tree::ptree& config, baldr::GraphReader& graphreader) {
  return std::make_shared<MotorScooterCost>(config, graphreader);
}
